...
$username   = "if0_42582231";
$password   = "sk3qNPsfSyJ";
$dbname     = "if0_42582231_sabye";
$fallback_db = "if0_42582231_work_shop";
$port       = 3306;
...
// เมื่อเปิดไฟล์ connect.php โดยตรง ให้แสดงผลการเชื่อมต่อสำเร็จสำหรับแคปเจอร์ส่งงาน
if (basename($_SERVER['SCRIPT_FILENAME']) === 'connect.php') {
    ...
    echo '<p class="fs-5 mb-0 text-primary"><strong>ผู้จัดทำ:</strong> นายศรัณยพงศ์ เอกอัครพรพล (เลขที่ 1)</p>';
